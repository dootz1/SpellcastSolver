...
to store the best version of each word. By using trie‑letter **bitmasks** for valid child nodes, 
...
| Gems [Swaps] | Avg Words | Avg Pts/Word | Avg Eval Score/Word | Time/Board <br> (⚡Multi-thread) | Time/Board <br/>(⏳Single-thread) |
|-------------:|----------:|-------------:|--------------------:|--------------------------------:|---------------------------------:|
